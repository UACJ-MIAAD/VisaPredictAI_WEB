...
// Encode one f32 as f16 bits. Math.f16round (Node ≥22 / ES2025) gives the
// correctly-rounded (round-to-nearest-even) f16 value; packing that value is
// then EXACT (all shifted-out mantissa bits are zero by construction).
