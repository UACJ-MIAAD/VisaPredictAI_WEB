...
export const PLAN_META = {
  dataMain: "1d6232b9df17300b633031d82b9dfd4cc7dcd898",
...
export const PLAN_EPICS: PlanEpic[] = [
  ...
  },
  {
    ...
    stories: [
      ...
      story("C8", c("Tooling honesto", "Honest tooling"), c("Medir cobertura y complejidad sobre el producto real.", "Measure coverage and complexity across the real product."), "active", "1d6232b · local"),
