...
export const PLAN_META = {
  dataMain: "bd8956d847602d7f412a8377b690b960b468101e",
...
export const PLAN_EPICS: PlanEpic[] = [
  ...
  },
  {
    ...
    stories: [
      ...
      story("C9", c("LOC por rol", "LOC by role"), c("Impedir que tooling vuelva a superar la mitad del producto.", "Prevent tooling from again exceeding half the product."), "active", "bd8956d · local"),
    ],
  },
  {
    id: "F",
